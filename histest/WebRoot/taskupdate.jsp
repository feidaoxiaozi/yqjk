...
<body>
<center>
<s:form method="post" action="updateYqjkxx.action" theme="simple">
...
<tr bgcolor="#353c44">
       ...
       <tr>               
           <td><s:hidden name="yqjkxx.roleId" value="%{yqjkxx.roleId}"></s:hidden></td>
      </tr>
  <tr>
    <td width="183" height="30" bgcolor="d3eaef" class="STYLE6"><div align="center"><span class="STYLE10">任务名称</span></div></td>
     ...
     <s:textfield name="yqjkxx.roleName" value="%{yqjkxx.roleName}"/>
    </span></div></td>
  ...
  <tr>
    ...
    <td height="30" bgcolor="d3eaef" class="STYLE6"><div align="center"><span class="STYLE19">
   <s:checkboxlist name="yqjkxx.newsResource" list="{'新闻','论坛','博客','贴吧','网页'}" value="%{yqjkxx.newsResource}" />
   </span></div></td>
  ...
  <tr>
    ...
    <td height="30" bgcolor="d3eaef" class="STYLE6"><div align="center"><span class="STYLE19">       
      <s:select name="yqjkxx.findStyle" list="{'标题&时间搜索','正文&相关度搜索'}" value="%{yqjkxx.findStyle}"/>
      
      <span class="STYLE10">采集时段</span> 
      <s:select name="yqjkxx.collectDate" list="{'五小时内','十小时内','当天','三天内','一周内','半个月内'}" value="%{yqjkxx.collectDate}"/>
    </span></div></td>
    </tr>
  <tr>
    <td width="183" height="30" bgcolor="d3eaef" class="STYLE6"><div align="center"><span class="STYLE10">搜索条件</span></div></td>
   <td height="30" bgcolor="d3eaef" class="STYLE6"><div align="center"><span class="STYLE19">
      <s:textarea name="yqjkxx.collectCondition" value="%{yqjkxx.collectCondition}"/>
    </span></div></td>
  ...
  <tr>
    ...
    <td height="30" bgcolor="d3eaef" class="STYLE6"><div align="center"><span class="STYLE19">
      <s:textfield name="yqjkxx.contentMate" value="%{yqjkxx.contentMate}"/>
    </span></div></td>
  ...
  <tr>
    ...
    <td height="30" bgcolor="d3eaef" class="STYLE6"><div align="center"><span class="STYLE19">
      &nbsp;&nbsp;&nbsp;<s:checkboxlist name="yqjkxx.Site_collection" list="{'启用'}" value="%{yqjkxx.Site_collection}"/>   
  ...
  <tr>
    ...
    <td height="30" bgcolor="d3eaef" class="STYLE6"><div align="center"><span class="STYLE19"><s:radio name="yqjkxx.roleState" list="{'启用','停用'}" value="%{yqjkxx.roleState}" />
      </span></div></td>
    </tr>
  <tr>
